    ...
    while(page <= limit):
        ...
        if page == 1:
            ...
            for h in higher:
                ...
                for champ in champs:
                    ...
                    champ_list_id.append(id_champ)
                # Se guarda el jugador
                writer1.add_document(idPlayer=count_players, name=higher_name,  urlPerfil=higher_url,  ranking=ranking,
                                     winrate=winrate, idsChampion=str(champ_list_id))
        ...
        for row in normal_table:
            ...
            for champ in champs:
                ...
                champ_list_id.append(id_champ)
            # Se guarda el jugador
            writer1.add_document(idPlayer=count_players, name=normal_name,  urlPerfil=normal_url,  ranking=normal_ranking,
                                 winrate=normal_winrate, idsChampion=str(champ_list_id))
            # Se incrementa el id del jugador
            count_players = count_players + 1
